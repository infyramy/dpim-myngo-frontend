...
const colorSchemes = [
  ...
  { name: 'dpim', value: 'dpim', hsl: '240 5.9% 10%' },
];
...
// Current selections
const currentColorScheme = ref(localStorage.getItem('theme-color') || 'green');
...
function applyThemeMode(mode: 'light' | 'dark' | 'auto') {
  ...
  const currentTheme = localStorage.getItem('theme-color') || 'green';
